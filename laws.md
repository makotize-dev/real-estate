...
- **国土交通省「宅地建物取引業法の解釈・運用の考え方」（令和8年4月1日施行版・55ページ）**＝**ユーザーのローカルPDF**：`G:\マイドライブ\不動産会社を運営するために\各種参考資料\宅地建物取引業法\国土交通省「宅地建物取引業法の解釈・運用の考え方」（令和8年4月版）.pdf`。**pypdf で全文抽出できる**（2026-08-17 実測・71,911字）。**節見出しは全角数字**で「第４６条第１項関係」の形式＝正規表現 `第[０-９]+条第?[０-９]*[項号]?関係` で全55節を列挙できる。**`第46条`（半角）では1件もヒットしない。**
  - **2026-08-17 に第46条第1項関係、2026-08-24 に第37条第1項第2号の2関係・第35条第1項第6号の2関係、2026-08-27 に第3条第1項関係・第15条の2関係・第33条関係・第35条第1項関係（全文18,618字。第4号／第5号／第6号／第6号の2／第8号／第10〜14号の各関係を含む）を `laws/解釈運用の考え方.md` へ保存済み。**他の条関係は未抽出＝必要になったら同じPDFから取る。**全55節の見出し一覧は `laws/解釈運用の考え方.md` の冒頭に記録した**（どの節が未取得かを見分けるため）。
