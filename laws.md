...
- **日本語PDFは `pypdf` で読める**。ただし**コンソールに直接 print すると文字化けする**ので、**必ずUTF-8でファイルに書き出してから読む**（2026-08-16 にこれを破って1往復を無駄にした）
...
- **宅地建物取引業者が宅地又は建物の売買等に関して受けることができる報酬の額**（昭和45年10月23日建設省告示第1552号・最終改正 令和6年6月21日国交省告示第949号／令和6年7月1日施行）＝**ユーザーのローカルPDF**：`G:\マイドライブ\不動産会社を運営するために\各種参考資料\宅地建物取引業法\宅建業者報酬上限告示（国土交通省）.pdf`（5ページ）。**pypdf で全文抽出できる**（2026-08-15 実測。縦書きのため1文字ずつ改行されるが逐語は完全。第一〜第十一＋附則）。**告示は著作権法13条2号**（「国若しくは地方公共団体の機関…が発する告示、訓令、通達その他これらに類するもの」）**により著作権の目的とならない**ので複製の制約はない。
